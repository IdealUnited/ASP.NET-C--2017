...
namespace SandLibrary
{
    public class SandDFRequestParamList
    {
        ...
        private Dictionary<string, object> SetKeyValue()
        {
            ...
            ParamDiclist.Add("orderCode|订单号|s|Y", "df" + DateTime.Now.ToString("yyyyMMddHHmmss") + GetRandomString());
            ParamDiclist.Add("timeOut|订单超时时间|s|N", "");
            ...
            ParamDiclist.Add("accNo|收款人账户号|s|Y", "");
            ParamDiclist.Add("accName|收款人账户名|s|Y", "");
            ParamDiclist.Add("provNo|开户省份编码|s|N", "010000");
            ParamDiclist.Add("cityNo|开户城市编码|s|N", "");
            ParamDiclist.Add("bankName|账户开户行名称|s|N", "");
            ParamDiclist.Add("bankType|收款人账户联行号|s|N","");
            ParamDiclist.Add("remark|摘要|s|N", "");
            ParamDiclist.Add("reqReserved|请求方保留域|s|N", "");
            ParamDiclist.Add("noticeUrl|付款结果通知地址|s|N", "");
