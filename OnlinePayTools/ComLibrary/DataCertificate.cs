...
namespace ComLibrary
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string cypher = RSAUtil.RSAEncrypt(keyPublic, "程序员");  // 加密
            string plain = RSAUtil.RSADecrypt(keyPrivate, cypher);  // 解密
            ...
            string cypher2 = RSAUtil.RSAEncrypt(keyPublic2, "程序员2");  // 加密
            string plain2 = RSAUtil.RSADecrypt(keyPrivate, cypher2);  // 解密, cer里面并没有私钥，所以这里使用前面得到的私钥来解密
            ...
            string cypher3 = RSAUtil.RSAEncrypt(keyPublic3, "程序员3");  // 加密
            string plain3 = RSAUtil.RSADecrypt(keyPrivate3, cypher3);  // 解密
